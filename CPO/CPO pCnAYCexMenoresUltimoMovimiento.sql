...
IF EXISTS(SELECT name FROM sys.objects o  WITH(nolock) WHERE name ='pCnAYCexMenoresUltimoMovimiento')
BEGIN
	DROP PROC pCnAYCexMenoresUltimoMovimiento
END
GO

CREATE PROC pCnAYCexMenoresUltimoMovimiento
AS
