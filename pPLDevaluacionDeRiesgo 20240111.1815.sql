...
ALTER PROC pPLDevaluacionDeRiesgo
@pIdSocio INT=0,
@pNoSocio VARCHAR(24)='',
...
BEGIN
	...
	*/
	...
	/*  |-------------------------------------------------------------|
		...
		IF @pDEBUG=1 SELECT 'DEPOSITOS DECLARADOS DE MENORES'
		...
		IF @pDEBUG=1 SELECT 'RETIROS DECLARADOS DE MENORES'
		...
		IF @pDEBUG=1 SELECT 'DEPOSITOS DECLARADOS DE MAYORES'
	...
	IF @pDEBUG<>1
	BEGIN
		/* ฅ^•ﻌ•^ฅ   JCA.21/09/2023.06:28 p. m. Nota: Se agrega validación de existencia de valores en variables de tabla, ya que se estabanm generando encabezados si algunos detalles   */
