...
IF EXISTS(SELECT name FROM sys.objects o WHERE o.name='pPLDdesagregadoOperacionesPorProductoMentodoDePago')
BEGIN
	DROP PROC pPLDdesagregadoOperacionesPorProductoMentodoDePago
	SELECT 'pPLDdesagregadoOperacionesPorProductoMentodoDePago BORRADO' AS info
END
GO

CREATE PROC pPLDdesagregadoOperacionesPorProductoMentodoDePago
