...
SELECT lgiro.Codigo AS GiroCodigo, lgiro.Descripcion AS Giro
...
INNER JOIN dbo.tAYCgiroFinalidades gf  WITH(nolock) ON gf.IdFinalidad = fin.IdFinalidad
INNER JOIN dbo.tCATlistasD lgiro  WITH(nolock) ON lgiro.IdListaD = gf.IdListaDGiro
ORDER BY Giro,FinalidadDescripcion
