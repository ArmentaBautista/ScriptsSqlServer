...
BEGIN
		...
		SELECT perfil.Codigo, perfil.Descripcion, usuario.Usuario, persona.Nombre, sesion.FechaTrabajo
		,sesion.IP,sesion.Host,sesion.Inicio,sesion.Fin,sesion.Version
