...
DECLARE @nombreBuscado AS VARCHAR(64)='laura hort'
...
--EVALUACIONES_POR_SOCIO_FECHA


EXEC dbo.pCnPLDmatrizEvaluacionNivelDeRiesgo @tipoOperacion = 'EVALUACIONES_POR_SOCIO_FECHA',          -- varchar(24)
                                             @fechaInicial = '2023-01-01', -- date
                                             @fechaFinal = '2023-06-15',   -- date
                                             @NoSocio = '010100056728'                 -- varchar(32)

EXEC dbo.pCnPLDmatrizEvaluacionNivelDeRiesgo @tipoOperacion = 'SOCIO_RESUMEN_EVALUACION',          -- varchar(24)
                                             @fechaInicial = '2023-01-01', -- date
                                             @fechaFinal = '2023-06-15',   -- date
                                             @NoSocio = '010100085840',
											 @folioEvaluacion=6

-- SOCIO_DETALLE_EVALUACION
EXEC dbo.pCnPLDmatrizEvaluacionNivelDeRiesgo @tipoOperacion = 'SOCIO_DETALLE_EVALUACION',          -- varchar(24)
                                             @fechaInicial = '2023-01-01', -- date
                                             @fechaFinal = '2023-06-15',   -- date
                                             @NoSocio = '010100085840',
											 @folioEvaluacion=6
...
-- TIPOS_OPERACION_SOCIO
EXEC dbo.pCnPLDmatrizEvaluacionNivelDeRiesgo @tipoOperacion = 'TIPOS_OPERACION_masiva'  




DECLARE @nombrecolumna AS VARCHAR(32)='IdListaDactividad'
...
SELECT * FROM dbo.tGRLnacionalidadesPersona
