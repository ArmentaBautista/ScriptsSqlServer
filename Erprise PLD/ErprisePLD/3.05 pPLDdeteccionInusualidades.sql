...
IF EXISTS(SELECT name FROM sys.objects o WHERE o.name='pPLDdeteccionInusualidades')
BEGIN
	DROP PROC pPLDdeteccionInusualidades
	SELECT 'pPLDdeteccionInusualidades BORRADO' AS info
END
GO

CREATE PROC pPLDdeteccionInusualidades
