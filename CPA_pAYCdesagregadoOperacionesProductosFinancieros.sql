...
ALTER PROC pAYCdesagregadoOperacionesProductosFinancieros 
@FechaInicial AS DATE='19000101',
@FechaFinal AS DATE ='19000101',
@NoSocio AS VARCHAR(30) ='*'
AS

	IF @FechaInicial='19000101' OR @FechaInicial IS NULL OR @FechaFinal='19000101' OR @FechaFinal IS NULL 
	BEGIN
