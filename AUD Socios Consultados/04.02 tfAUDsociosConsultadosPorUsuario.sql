-- -- 04.02 tfAUDsociosConsultadosPoUsuario.sql
IF (OBJECT_ID('tfAUDsociosConsultadosPorUsuario') IS NOT NULL)
        BEGIN
            DROP FUNCTION dbo.tfAUDsociosConsultadosPorUsuario
            SELECT 'tfAUDsociosConsultadosPorUsuario BORRADO' AS info
        END
GO

CREATE FUNCTION dbo.tfAUDsociosConsultadosPorUsuario(
