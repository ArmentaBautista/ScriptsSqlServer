--04.03 tfAUDsociosConsultadosPorSocio.sql

IF (OBJECT_ID('tfAUDsociosConsultadosPorSocio') IS NOT NULL)
        BEGIN
            DROP FUNCTION dbo.tfAUDsociosConsultadosPorSocio
            SELECT 'tfAUDsociosConsultadosPorSocio BORRADO' AS info
        END
GO

CREATE FUNCTION dbo.tfAUDsociosConsultadosPorSocio(
