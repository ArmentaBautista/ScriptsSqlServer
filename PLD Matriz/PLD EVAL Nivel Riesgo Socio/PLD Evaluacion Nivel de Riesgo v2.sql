...
SELECT * FROM @calificacionesAgrupadas
...
/*
 ...
 SET @idEvaluacionRiesgo= SCOPE_IDENTITY();
	...
	INSERT INTO dbo.tPLDmatrizEvaluacionesRiesgoCalificacionesFinales (IdEvaluacionRiesgo,IdSocio,Calificacion,NivelDeRiesgo,IdEstatus)
	SELECT @idEvaluacionRiesgo, c.IdSocio, c.Calificacion , n.NivelRiesgoDescripcion, 1 FROM @calificacionesFinales c  
	INNER JOIN dbo.tPLDmatrizConfiguracionNivelesRiesgo n ON c.Calificacion BETWEEN n.Valor1 AND n.Valor2 AND n.Tipo=2
