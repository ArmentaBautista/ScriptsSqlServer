...
BEGIN    
	INSERT INTO dbo.tPLDmatrizConfiguracionProductosServicios (Tipo,IdValor1,ValorDescripcion,Puntos) VALUES(1,@IdRegistro,@descripcion,FLOOR(rand()*101))
...
WHILE @@FETCH_STATUS = 0
BEGIN    
	INSERT INTO dbo.tPLDmatrizConfiguracionProductosServicios (Tipo,IdValor1,ValorDescripcion,Puntos) VALUES(2,@IdRegistro,@descripcion,FLOOR(rand()*101))
