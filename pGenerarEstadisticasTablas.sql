...
IF EXISTS(SELECT name FROM sys.objects o WHERE o.name='pCTLgenerarEstadisticasTablas')
	DROP PROC pCTLgenerarEstadisticasTablas
GO

CREATE PROC pCTLgenerarEstadisticasTablas 
AS
