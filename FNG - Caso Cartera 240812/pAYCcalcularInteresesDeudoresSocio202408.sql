...
IF(object_id('pAYCcalcularInteresesDeudoresSocio202408') IS NOT NULL)
BEGIN
	DROP PROCEDURE pAYCcalcularInteresesDeudoresSocio202408
	SELECT 'pAYCcalcularInteresesDeudoresSocio202408 BORRADO' AS info
END
GO

CREATE PROCEDURE dbo.pAYCcalcularInteresesDeudoresSocio202408
