...
IF(object_id('ifAYCcalcularInteresesDeudoresSocio') IS NOT NULL)
BEGIN
	DROP FUNCTION ifAYCcalcularInteresesDeudoresSocio
	SELECT 'ifAYCcalcularInteresesDeudoresSocio BORRADO' AS info
END
GO

CREATE FUNCTION dbo.ifAYCcalcularInteresesDeudoresSocio
(
    @IdCuenta AS INT = 0, -- 0 = Todas la Cuentas
    @IdSocio AS INT = 0,
    @FechaTrabajo AS DATE,
    @Decimales AS INT = 2,
    @CodigoOperacion AS VARCHAR(20) = ''
)
RETURNS @cartera TABLE(
    [IdCuenta] INT,
    [IdSaldo] INT,
    [IdParcialidad] INT,
    [IdPeriodo] INT,
    ...
    [Fin] DATE,
    [Vencimiento] DATE,
    [SaldoCapital] DECIMAL(25, 8),
    [SaldoInteresOrdinario] DECIMAL(25, 8),
    [SaldoIVAinteresOrdinario] DECIMAL(25, 8),
    [SaldoInteresMoratorio] DECIMAL(25, 8),
    [SaldoIVAinteresMoratorio] DECIMAL(25, 8),
    [SaldoInteresOrdinarioEstimado] DECIMAL(23, 8),
    [SaldoIVAinteresOrdinarioEstimado] DECIMAL(38, 7),
    [SaldoInteresMoratorioEstimado] DECIMAL(23, 8),
    [SaldoIVAinteresMoratorioEstimado] DECIMAL(38, 7),
    [SaldoInteresOrdinarioCuentasOrden] DECIMAL(23, 8),
    [SaldoIVAinteresOrdinarioCuentasOrden] DECIMAL(38, 7),
    [SaldoInteresMoratorioCuentasOrden] DECIMAL(23, 8),
    [SaldoIVAinteresMoratorioCuentasOrden] DECIMAL(38, 7),
    [SaldoAhorro] DECIMAL(24, 8),
    [SaldoCargo1] DECIMAL(18, 2),
    [SaldoIVACargo1] DECIMAL(18, 2),
    [SaldoCargo2] DECIMAL(18, 2),
    [SaldoIVACargo2] DECIMAL(18, 2),
    [SaldoCargo3] DECIMAL(18, 2),
    [SaldoIVACargo3] DECIMAL(18, 2),
    [SaldoCargo4] DECIMAL(18, 2),
    [SaldoIVACargo4] DECIMAL(18, 2),
    [SaldoCargo5] DECIMAL(18, 2),
    [SaldoIVACargo5] DECIMAL(18, 2),
    [EsExigible] BIT,
    [DiasTranscurridos] INT,
    [InteresOrdinarioDiario] DECIMAL(38, 7),
    [DiasParcialidad] INT,
    [InteresOrdinario] DECIMAL(38, 6),
    [IVAinteresOrdinario] DECIMAL(38, 6),
    [MoraMaxima] INT,
    [DiasMoraTotal] INT,
    [DiasMora] INT,
    [InteresMoratorioDiario] DECIMAL(38, 6),
    [InteresMoratorio] DECIMAL(38, 6),
    [IVAinteresMoratorio] DECIMAL(38, 6),
    [FechaVencido] DATE,
    [DiasVencido] INT,
    [DiasMoraVencido] INT,
    [CalcularMoratoriosBalance] BIT,
    [DiasMoraVencidox] INT,
    [PendienteDevengar] DECIMAL(38, 6),
    [IVApendienteDevengar] DECIMAL(38, 6),
    [PendientePagar] DECIMAL(38, 6),
    [PendientePagarSinAjuste] DECIMAL(38, 6),
    [AjustePendientePagar] DECIMAL(38, 6),
    [OverPartition] DECIMAL(38, 6),
    [IVApendientePagar] DECIMAL(38, 6),
    [PendienteDevengarVencido] DECIMAL(38, 6),
    [Orden] INT,
    [FechaUltimoAtraso] DATE,
    [TasaIva] DECIMAL(23, 8),
    [IdTipoDParcialidad] INT,
    [IdSocio] INT,
    [CapitalMasAtrasado] DECIMAL(25, 8),
    [AplicaAjuste] INT,
    [InteresOrdinarioCalculadoAcumulado] DECIMAL(38, 6),
    [AjusteInteresOrdinarioPagosFijos] DECIMAL(38, 6),
    [IVAInteresOrdinarioCalculadoAcumulado] DECIMAL(38, 6),
    [AjusteIVAInteresOrdinarioPagosFijos] DECIMAL(38, 6),
    [InteresOrdinarioCalculado] DECIMAL(24, 8),
    [InteresOrdinarioEstimado] DECIMAL(23, 8),
    [IVAInteresOrdinarioEstimado] DECIMAL(23, 8),
    [IVAinteresOrdinarioDevengado] DECIMAL(23, 8),
    [EstaPagada] BIT,
    [DiasValidacionCalculo] INT
)
AS
begin
    ...
    (
		...
		*/
        ...
        FROM @cuentas cuenta 
            ...
            JOIN dbo.tAYCparcialidades parcialidades WITH (NOLOCK)
            ...
            (
                SELECT parcialidad.IdParcialidad,
                       ...
                       cuenta.IdCuenta
                FROM @cuentas cuenta 
                    INNER JOIN dbo.tAYCparcialidades parcialidad  WITH(NOLOCK) 
